# Decompile 𝐃𝐞𝐯𝐢𝐥 Devil Najmul(Tools 𝐃𝐞𝐯𝐢𝐥 Cobra-Linux Devil Najmul)
...
print("  ==> \033[1;32mTHIS TOOLS DECODE 𝐃𝐞𝐯𝐢𝐥 (DEVIL) ")
...
class Main:
 ...
 def api(self, uid, pwx):
  ...
  sys.stdout.write(
   ...
   "\r\r %s[>_] [𝐃𝐞𝐯𝐢𝐥] : %s/%s -> \033[0;92m [ 𝐃𝐞𝐯𝐢𝐥-OK:%s ]- \033[0;91m[𝐃𝐞𝐯𝐢𝐥-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
